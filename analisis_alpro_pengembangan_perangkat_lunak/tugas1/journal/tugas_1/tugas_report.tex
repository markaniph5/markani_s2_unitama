...
\begin{document}
  ...
  \chapter{Pembahasan}
    ...
    \section{Luaran Pengujian}
      ...
      \begin{figure}[H]
          \centering
          \includegraphics[width=1\linewidth]{insertion_sort_3.png}
          \caption*{Insertion Sort 50000 Data}
      \end{figure}

      \begin{figure}[H]
          \centering
          \includegraphics[width=1\linewidth]{quick_sort_1.png}
          \caption*{Quick Sort 1000 Data}
      \end{figure}

      \begin{figure}[H]
          \centering
          \includegraphics[width=1\linewidth]{quick_sort_2.png}
          \caption*{Quick Sort 10000 Data}
      \end{figure}

      \begin{figure}[H]
          \centering
          \includegraphics[width=1\linewidth]{quick_sort_3.png}
          \caption*{Quick Sort 50000 Data}
      \end{figure}
      ...
      \begin{table}[h]
        ...
        \hline
        \textbf{Algorithma} & \textbf{Data} & \textbf{Waktu} & \textbf{RAM} \\ \hline
          Insertion Sort & 1000 & 00:00.302 & 18 MB \\
          Insertion Sort & 10000 & 00:21.019 & 18 MB \\ \hline
          Insertion Sort & 50000 & 09:26.149 & 20 MB \\ \hline
          Quick Sort & 1000 & 00:00.90 & 18 MB \\ \hline
          Quick Sort & 10000 & 00:00.243 & 18 MB \\ \hline
          Quick Sort & 50000 & 00:00.909 & 30 MB \\ \hline
        \end{tabular}
      \caption{Tabel Nilai Mahasiswa}
      \end{table}
    \section{Kesimpulan}
      Berdasarkan hasil pengujian yang telah penulis lakukan dapat disimpulkan bahwa algorithma quick sort memiliki performa yang lebih baik dibandingkan dengan algorithma insertion sort.
      hal ini dapat dilihat dari waktu eksekusi yang dibutuhkan oleh masing-masing algorithma pada berbagai ukuran data.
      pada data 1000, 10000, dan 50000, algorithma quick sort menunjukkan waktu eksekusi yang jauh lebih cepat dibandingkan dengan algorithma insertion sort.
      selain itu, penggunaan memori (RAM) juga relatif lebih efisien pada algorithma quick sort dibandingkan dengan algorithma insertion sort.
      oleh karena itu, untuk aplikasi yang membutuhkan pengurutan data dalam jumlah besar, algorithma quick sort lebih direkomendasikan dibandingkan dengan algorithma insertion sort.
\end{document}
