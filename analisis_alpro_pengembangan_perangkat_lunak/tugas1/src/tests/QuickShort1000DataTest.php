...
final class SelectionShort1000DataTest extends TestCase
{
    ...
    public function testAlgoithmQuickSortInputOneThaousandOutputAreEquals(): void
    {
        // generate 1000 data
        $total_data = 1000;
        $data = [];
    ...
    public function testAlgoithmQuickSortInputFivetyThaousandOutputAreEquals(): void
    {
        // generate data
        $total_data = 50000;
        $data = [];
